/** The StudyPal mark from the post-templates/*.html designs - rounded tile in `tile`, glyph in `ink`. */
export function StudyPalLogo({ size, tile, ink }: { size: number; tile: string; ink: string }) {
  return (
    <svg viewBox="0 0 300 300" style={{ width: size, height: size, flex: "none" }} role="img" aria-label="StudyPal logo">
      <rect width="300" height="300" rx="64" fill={tile} />
      <g fill={ink} transform="matrix(2.3512290156904005,0,0,2.3512290156904005,31.75624218697046,30.09)">
